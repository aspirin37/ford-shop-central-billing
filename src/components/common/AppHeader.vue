                                ...
                                <div class="container">
                                    <div class="central-billing__wrapper">
                                        <div
                                            v-for="it in catalog"
                                            :key="it.type"
                                            :sub-catalog-type="it.type"
                                            class="central-billing__item"
                                            :class="{'active': selectedSubCatalog && it.type === selectedSubCatalog.type}"
                                            @click="selectSubCatalog(it.type, it.label)"
                                        >
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                sub-catalog-type="security"
                                                class="central-billing__deep__item"
                                            >
                                                <span class="central-billing__deep__item__title">
                                                    {{ selectedSubCatalog.label }}
                                                </span>
                                                <div class="central-billing__deep__item__links-block">
                                                    <a
                                                        v-for="(it, i) in subCatalog"
                                                        :key="i"
